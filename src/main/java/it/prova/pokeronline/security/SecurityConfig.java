...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable() // Disabling csrf
				...
				.antMatchers("/api/gestioneAmministrazione/**").hasRole("ADMIN").antMatchers("/api/gestioneTavolo/**")
				.hasAnyRole("ADMIN", "SPECIAL_PLAYER").antMatchers("/api/playManagement/**")
				.hasAnyRole("ADMIN", "PLAYER", "SPECIAL_PLAYER").antMatchers("/**")
				.hasAnyRole("ADMIN", "PLAYER", "SPECIAL_PLAYER")
